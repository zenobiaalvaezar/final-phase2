...
type WebhookPayload struct {
	ExternalID string  `json:"external_id" example:"rental-123"`
...
// @Accept json
// @Produce json
// @Param request body handlers.WebhookPayload true "Webhook Data"
// @Success 200 {object} map[string]string "message: Webhook processed"
...
// @Failure 404 {object} map[string]string "message: Payment not found"
